...
$modelData = mysqli_query(
    $conn,
    "SELECT * FROM model_master ORDER BY model_name"
);

$defectData = mysqli_query(
    $conn,
    "SELECT * FROM defect_master ORDER BY defect_name"
);
...
$rootcauseData = mysqli_query(
    $conn,
    "SELECT * FROM rootcause_master ORDER BY rootcause_name"
);

$actionData = mysqli_query(
    $conn,
    "SELECT * FROM action_master ORDER BY action_name"
);
